...
{% hint style="info" %}
**You may obtain the static binaries for version 1.35.0 via this** [**link** ](https://github.com/armada-alliance/cardano-node-binaries/blob/main/static-binaries/1_35_0.zip?raw=true)**thanks to Moritz Angermann, the SPO of ZW3RK pool 🙏**
{% endhint %}
